...
export default function Register() {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // Auto-seed if admin to give demo content
            if (u.role === "admin") {
                ...
                <div className="relative z-10 p-12 h-full flex flex-col justify-between text-white">
                    ...
                    <div>
                        <h1 className="font-heading text-5xl font-black tracking-tighter leading-none mb-4">
                            ...
                            <span className="text-blue-400">built for chartering.</span>
                        </h1>
                        <p className="text-zinc-300 max-w-md text-base leading-relaxed">
                            Sign up as an <span className="text-white font-semibold">Admin</span> to auto-load demo fixtures, or pick your team role.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center p-8 lg:p-16">
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={onSubmit} className="space-y-5" data-testid="register-form">
                        <div>
                            ...
                            <input data-testid="register-name-input" required value={form.name} onChange={(e)=>setForm({...form, name:e.target.value})}
                                className="w-full bg-transparent border border-zinc-300 p-3 text-sm focus:border-blue-600 focus:ring-2 focus:ring-blue-600 focus:outline-none rounded-none" />
                        </div>
                        <div>
                    ...
                    <div className="mt-8 pt-6 border-t border-zinc-200 text-sm text-zinc-500">
                        ...
                        <Link to="/login" className="font-semibold text-blue-600 hover:text-blue-700" data-testid="go-login-link">
                            Sign in
                        </Link>
                    </div>
                </div>
